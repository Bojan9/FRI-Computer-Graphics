...
export class FirstPersonController {
    ...
    constructor(node, domElement) {
        // Add a flag to determine whether the camera movement is allowed
    ...
    // Add a method to toggle the camera movement
    toggleCameraMove() {
        this.isCameraMoveAllowed = !this.isCameraMoveAllowed;
    }

    // Modify the keydown and keyup handlers to check for camera movement
    keydownHandler(e) {
        if (this.isCameraMoveAllowed) {
